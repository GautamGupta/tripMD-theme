        ...
        <div class="block full-width-form review">
            ...
            <div class="card info grid-container">
                ...
                <?php if ( empty( $dont_display_form ) ) : ?>
                    ...
                    <p class="yeh-vala"><?php printf( __( 'Your Doctor %1$s has been selected to be featured on %3$s, a highly curated platform aimed at helping expats access high quality healthcare in foreign cities. Recognized as one of New Delhi’s best doctors by the local expatriate and diplomatic communities, we are looking to spread the word of Dr. %2$s’s great practice.' ), $first_name . ' ' . $last_name, !empty( $last_name ) ? $last_name : $first_name, get_bloginfo( 'blogname' ) ); ?></p>
