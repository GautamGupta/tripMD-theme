...
?>
	...
	<?php if ( $query->have_posts() ) : ?>
		...
		<div class="heading grid-100"><h2 class="animated fadeIn"><?php printf( "%s Treatments", get_the_title() ); ?></h2></div>
		<h4 class="animated fadeIn aligncenter">Our experienced doctors will ensure your safe treatment.</h4>
